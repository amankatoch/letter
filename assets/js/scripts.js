...
$j(document).ready(function($){
    //iframeLoaded();
        ...
        $('#datepicker1').datepicker();
                  ...
                  $('#isch').click(function(){
                    var chk_val=$(this).attr('checked');
                      if(chk_val=='checked')
                      {
                        $('.schedule').show();
                        $('#send_now').attr('value','Schedule');
                      }
                      else
                      {
                        $('.schedule').hide();
                             $('#send_now').attr('value','Send Now');
                      }
...
function export_template(){
   ...
   //       var row1 = $j(this).clone();
		 // row1.find('.esf-row-delete').remove();
		 // row1.find('.esf-row-editrow').remove();
		 // row1.find('.esf-row-edit').removeAttr('data-type');
		 // row1.find('.esf-row-edit').removeAttr('class');
		 // row1.find('.esf-row-edit').removeClass('esf-row-edit');
		 // output1 += row.html();
	});
    var row_1content = $j('#builder-frame').contents().find('#newsletter-builder-area-center-frame-content');
         var row1=row_1content.clone();
    ...
    $j('#template-output-filter').val(output1);
